      ...
      <table className='w-full border-collapse text-sm custom-table'>
        ...
        {list.map(({option, type, desc = ''}, index) => {
          return (
            ...
            >
              <td
                className='whitespace-pre py-2 font-mono text-xs font-semibold leading-6 text-violet-600 dark:text-violet-500'>
                {option}
              </td>
              <td
                className='whitespace-pre py-2 pl-6 font-mono text-xs font-semibold leading-6 text-slate-500 dark:text-slate-400'>
                {type}
              </td>
