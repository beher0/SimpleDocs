...
GitHub Pages 必须在每个 repo 的基础上打开, 打开它时，您可以选择要服务的分支,将服务设置在`.gh-pages`分支

在浏览器中, 打开 GitHub 里的项目 repo
...
而 GitHub Pages 托管站点的 URL 为:`https://<你的 github name>.github.io/<repo>`

如: https://simplelifecst.github.io/nextra-template/
