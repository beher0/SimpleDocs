...
<Table
  list={[
    ...
    },
    {
      ...
      type: "boolean | string",
      desc:
        "默认是项目首页，可以使用true/false关闭链接，也可以更改为其他跳转路径",
    },
  ]}
></Table>
  ...
  list={[
    {
      ...
      type:
        "React.ReactNode | React.FC<{ className?: string, directories: Item[]}>",
      desc: "搜索栏组件，可重写搜索栏",
    },
    {
...
<Table
  list={[
    ...
    },
    {
      ...
      type: "boolean",
      desc:
        "如果为true，则自动折叠defaultMenuCollapseLevel上方的非活动文件夹。",
    },
    {
      option: "sidebar.titleComponent",
      type:
        "React.ReactNode | React.FC<{type: string;title: string;route: string;}>",
      desc: "自定义渲染侧边栏标题的组件。",
    },
    {
...
<Table
  list={[
    ...
    },
    {
      ...
      type:
        "React.FC<{children: React.ReactNode;className?: string;filePath?: string;}",
      desc: "定制的编辑链接组件。",
    },
  ]}
></Table>
...
<Table
  list={[
    ...
    },
    {
      ...
      type: "() => string",
      desc:
        "默认情况下，自定义链接将在“docsRepositoryBase”中设置的存储库中打开一个问题。",
    },
  ]}
></Table>
